...
// "/login"(가입 유형 선택·후원자 가입·로그인, Phase 6), "/mypage"·"/profile"(마이페이지·
// 프로필, 2026-09-09 추가)은 신규 WEWE 전체 소개 홈페이지(WeweSite, 자체 BrowserRouter를
// 가진 별도의 React 트리)를 렌더링한다. 이 목록은 WeweSite.jsx의 <Routes>와는 별개이므로,
// WeweSite에 새 경로를 추가할 때는 반드시 여기 isWeweSitePath에도 함께 추가해야 한다.
